        ...
        <div>
         <h1 className="tagline" >Crack the Code!</h1>
          <div className="description">
            ...
            <br />
            <h1>Welcome to /////////, where coding challenges transform into solutions! Whether you're a seasoned developer honing your skills or a beginner taking your first steps into the world of coding, we have something for everyone.</h1>
