        ...
        <div className="specify1" >
            <div className="specify-item">
                ...
                <div className="specify-item-child practice " >
                    ...
                    <p>"Strengthen your grasp on DSA topics by diving into practical questions and challenges on our code practice website. Engage in hands-on problem-solving to master Data Structures and Algorithms effectively."</p>
                </div>
            </div>
        </div>
        <div className="specify1" >
